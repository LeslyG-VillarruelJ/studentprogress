...
function xmldb_local_studentprogress_install() {
    ...
    if (!$dbman->table_exists('course_duration_plg')) {
        ...
        $table->add_field('id_course_alert_duration', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_course_alert_duration']);
    ...
    if (!$dbman->table_exists('course_alerts_plg')) {
        ...
        $table->add_field('id_course_alerts', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('id_course', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('alert', XMLDB_TYPE_CHAR, '255', null, XMLDB_NOTNULL, null, '');

        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_course_alerts']);
        $table->add_index('id_course_ix', XMLDB_INDEX_NOTUNIQUE, ['id_course']);
    ...
    if (!$dbman->table_exists('learning_type_plg')) {
        ...
        $table->add_field('id_learning_type', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('name', XMLDB_TYPE_CHAR, '100', null, XMLDB_NOTNULL, null, '');

        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_learning_type']);
    ...
    if (!$dbman->table_exists('learning_course_module_plg')) {
        ...
        $table->add_field('id_lcm_learning', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_lcm_learning']);
        ...
        $table->add_foreign_key('fk_learning_type', 'id_learning', 'learning_type_plg', 'id_learning_type', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
    ...
    if (!$dbman->table_exists('user_learning_plg')) {
        ...
        $table->add_field('id_user_learning', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('id_user', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
        $table->add_field('id_learning', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);

        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_user_learning']);
        ...
        $table->add_foreign_key('fk_learning', 'id_learning', 'learning_type_plg', 'id_learning_type', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
    ...
    if (!$dbman->table_exists('user_learning_module_plg')) {
        ...
        $table->add_field('id_user_learning_module', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_user_learning_module']);
        ...
        $table->add_foreign_key('fk_user_learning', 'id_user_learning', 'user_learning_plg', 'id_user_learning', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
        $table->add_foreign_key('fk_learning_module', 'id_learning_course_module', 'learning_course_module_plg', 'id_lcm_learning', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
    ...
    if (!$dbman->table_exists('user_sections_grades_plg')) {
        ...
        $table->add_field('id_user_section_grades', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        ...
        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_user_section_grades']);
        ...
        $table->add_foreign_key('fk_user_learning_gr', 'id_user_learning', 'user_learning_plg', 'id_user_learning', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
    ...
    if (!$dbman->table_exists('user_sections_plg')) {
        ...
        $table->add_field('id_user_section', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('id_section', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
        $table->add_field('id_user_learning', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
        $table->add_field('status', XMLDB_TYPE_CHAR, '50', null, XMLDB_NOTNULL, null, '');

        $table->add_key('primary', XMLDB_KEY_PRIMARY, ['id_user_section']);
        $table->add_index('idx_section', XMLDB_INDEX_NOTUNIQUE, ['id_section']);
        $table->add_index('idx_user_learning', XMLDB_INDEX_NOTUNIQUE, ['id_user_learning']);

        $table->add_foreign_key('fk_section_status', 'id_section', 'course_sections', 'id', XMLDB_KEY_FOREIGN, 'RESTRICT', 'RESTRICT');
        $table->add_foreign_key('fk_user_learning_status', 'id_user_learning', 'user_learning_plg', 'id_user_learning', XMLDB_KEY_FOREIGN, 'CASCADE', 'RESTRICT');
